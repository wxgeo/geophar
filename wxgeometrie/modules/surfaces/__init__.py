...
[0.5, 0, 0],
        ...
        ligne = QHBoxLayout()
        ligne.Add(QLabel(self, "Xmin"), 0, wx.ALIGN_CENTRE|wx.ALL,5)
        ...
        ligne = QHBoxLayout()
        ligne.Add(QLabel(self, u"Xmax"), 0, wx.ALIGN_CENTRE|wx.ALL,5)
        ...
        ligne = QHBoxLayout()
        ligne.Add(QLabel(self, u"Pas"), 0, wx.ALIGN_CENTRE|wx.ALL,5)
        ...
        ligne = QHBoxLayout()
        ligne.Add(QLabel(self, u"Ymin"), 0, wx.ALIGN_CENTRE|wx.ALL,5)
        ...
        ligne = QHBoxLayout()
        ligne.Add(QLabel(self, u"Ymax"), 0, wx.ALIGN_CENTRE|wx.ALL,5)
