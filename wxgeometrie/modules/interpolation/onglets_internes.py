...
#        self.add(sizer)
        ...
        sizer = wx.BoxSizer(wx.HORIZONTAL)
        self.sc = wx.StaticText(self, -1, u"Liste des valeurs en x:  ")
        sizer.Add(self.sc, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 5)
        self.classes = wx.TextCtrl(self, -1, 'xl', size=(500, -1), style=wx.TE_PROCESS_ENTER)
        self.classes.SetToolTipString(u"Exemple:\n[0,4,7]")
        self.classes.Bind(wx.EVT_CHAR, self.main.EvtChar)
        sizer.Add(self.classes, 0, wx.EXPAND|wx.ALIGN_CENTER_VERTICAL|wx.ALL, 4)
        self.add(sizer)
        ...
        sizer = wx.BoxSizer(wx.HORIZONTAL)
        self.sc = wx.StaticText(self, -1, u"Liste des valeurs en y:  ")
        sizer.Add(self.sc, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 5)
        self.classes = wx.TextCtrl(self, -1, 'yl', size=(500, -1), style=wx.TE_PROCESS_ENTER)
        self.classes.SetToolTipString(u"Exemple:\n[0.5,4.2,6.3]")
        self.classes.Bind(wx.EVT_CHAR, self.main.EvtChar)
        sizer.Add(self.classes, 0, wx.EXPAND|wx.ALIGN_CENTER_VERTICAL|wx.ALL, 4)
        self.add(sizer)
        ...
        sizer = wx.BoxSizer(wx.HORIZONTAL)
        self.sc = wx.StaticText(self, -1, u"Liste des nombres dérivés:  ")
        sizer.Add(self.sc, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 5)
        self.classes = wx.TextCtrl(self, -1, 'derivl', size=(500, -1), style=wx.TE_PROCESS_ENTER)
        self.classes.SetToolTipString(u"Exemple:\n[1,-1,0.5]")
        self.classes.Bind(wx.EVT_CHAR, self.main.EvtChar)
        sizer.Add(self.classes, 0, wx.EXPAND|wx.ALIGN_CENTER_VERTICAL|wx.ALL, 4)
        self.add(sizer)
...
class OngletsInterpolation(wx.Notebook):
    def __init__(self, parent):
        self.parent = parent
