...
if param.python_version >= 2.5:
    messages[BaseException] = u"""Common base class for all exceptions"""
    messages[GeneratorExit] = u"""Request that a generator exit."""
    messages[ImportWarning] = u"""Base class for warnings about probable mistakes in module imports"""
    messages[UnicodeWarning] = u"""Problème d'encodage."""
