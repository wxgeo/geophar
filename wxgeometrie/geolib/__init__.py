...
from .interpolations import Interpolation_generique, Interpolation_lineaire, Interpolation_quadratique, Interpolation_cubique, Interpolation_polynomiale_par_morceaux
...
from .lignes import Ligne_generique, Segment, Demidroite, Droite_generique, Droite, Point_droite, Droite_vectorielle, Parallele, Perpendiculaire, Mediatrice, Droite_equation, Bissectrice, Point_tangence, Tangente, Demiplan, Axe, Tangente_courbe_interpolation, Tangente_glisseur_interpolation
